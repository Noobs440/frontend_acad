(function () {
  ...
  if (mobileNavToggleBtn && bodyElement) {
  ...
  function initSwiper() {
    document.querySelectorAll(".init-swiper").forEach(function (swiperElement) {
      let configContainer = swiperElement.querySelector(".swiper-config");
      if (configContainer) {
        let config = JSON.parse(configContainer.innerHTML.trim());
  ...
  /**
   * Fix scroll position if URL has hash
   */
