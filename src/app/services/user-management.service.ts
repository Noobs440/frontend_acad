...
export class UserManagementService {
  ...
  private API_BASE = 'https://dschangschoolhub.ddns.net/api/user-management';
...
searchUsersByEmail(term: string): Observable<any[]> {
  return this.http.get<any[]>(`https://dschangschoolhub.ddns.net/api/users?role=user&search=${encodeURIComponent(term)}`);
}
