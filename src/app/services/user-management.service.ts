...
export class UserManagementService {
  ...
  private API_BASE = 'https://dschangschoolhub.duckdns.org/api/user-management';
...
searchUsersByEmail(term: string): Observable<any[]> {
  return this.http.get<any[]>(`https://dschangschoolhub.duckdns.org/api/users?role=user&search=${encodeURIComponent(term)}`);
}
