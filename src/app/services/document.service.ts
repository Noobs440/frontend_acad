...
export class DocumentService {
  ...
  private baseUrl = 'https://dschangschoolhub.ddns.net/api/ressources/documents';
  ...
  return this.http.post<any>('https://dschangschoolhub.ddns.net/api/ressources/documents', formData);
}

updateDocumentMultipart(id: number, formData: FormData) {
  formData.append('_method', 'PUT'); // important !
  return this.http.post<any>(`https://dschangschoolhub.ddns.net/api/ressources/documents/${id}`, formData);
}
  getDocumentsByProject(id:number): Observable<any[]>{
    return this.http.get<any[]>(`https://dschangschoolhub.ddns.net/api/usecases/listing/projet/documents/${id}`).pipe(
