...
export class CollaborateurService {
  ...
  private apiUrl = 'https://dschangschoolhub.ddns.net/api/ressources/collaborateurs';
  ...
  addCollaborateur(nom_collab: string, email_collab: string, projet_id: string, user_id: number): Observable<any> {
    return this.http.post<any>(`https://dschangschoolhub.ddns.net/api/usecases/add/collaborateur/projet/${projet_id}`, { nom_collab, email_collab, user_id });
  }
...
updateCollaborateur(id: number, nom_collab:string, email_collab:string, tbl_projet_id:number, user_id:number): Observable<any> {
  return this.http.put<any>(`https://dschangschoolhub.ddns.net/api/ressources/collaborateurs/${id}`,{nom_collab,email_collab,tbl_projet_id,user_id });
}

   getCollaborateursByProject(id:number): Observable<any[]>{
    return this.http.get<any[]>(`https://dschangschoolhub.ddns.net/api/usecases/listing/projet/collaborateurs/${id}`).pipe(
