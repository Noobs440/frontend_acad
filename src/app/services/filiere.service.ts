...
export class FiliereService {
  ...
  addFiliere(nom_fil:string , tbl_faculte_id:string):Observable<any>{
    return this.http.post<any>('https://uds-faculte-des-sciences.netlify.app//api/ressources/filieres', {nom_fil , tbl_faculte_id});
  }

  deleteFiliere(id:string):Observable<any>{
    return this.http.delete(`https://uds-faculte-des-sciences.netlify.app//api/ressources/filieres/${id}`);
  }

  updateFiliere(id:string ,nom_fil:string , tbl_faculte_id:string):Observable<any>{
    return this.http.put<any>(`https://uds-faculte-des-sciences.netlify.app//api/ressources/filieres/${id}`, {nom_fil , tbl_faculte_id});
  }
